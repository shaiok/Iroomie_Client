...
// const ApartmentPreviewCard = ({ apartment, vote }) => {
...
//             className="flex flex-col p-8 cursor-pointer w-full md:w-3/5 gap-8 relative"
//           >
...
//                 </span>
//               </div>
//               <div className="flex items-baseline bg-blue-600 absolute top-0 right-0 p-4 rounded-es-3xl">
//                 <span className="text-2xl font-bold text-white">
//                   ₪{info.financials.rent.toLocaleString()}
//                 </span>
//                 <span className="text-sm font-normal text-gray-100 ml-1">
//                   /mo
//                 </span>
//               </div>
//             </div>
...
//               <div className="flex items-center p-4 bg-gray-50/60 rounded-lg">
//                 <Home className="w-5 h-5 mr-4 text-blue-500" />
...
//               </div>
//               <div className="flex items-center p-4 bg-gray-50/60 rounded-lg">
//                 <Bath className="w-5 h-5 mr-4 text-blue-500" />
//                 <span>{info.specifications.bathrooms} bath</span>
//               </div>
//               <div className="flex items-center p-4 bg-gray-50/60 rounded-lg">
//                 <DollarSign className="w-5 h-5 mr-4 text-blue-500" />
...
//               + ₪{info.financials.securityDeposit.toLocaleString()} deposit
//             </div>
//           </div>
//         </div>
//       </Card>
